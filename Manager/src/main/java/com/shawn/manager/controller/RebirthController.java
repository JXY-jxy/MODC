...
public class RebirthController {
    ...
    public Result<List<Rebirth>> queryRebirth(@RequestParam(value = "rebirthId") String rebirthId,
                                              ...
                                              @RequestParam(value = "rebirthState") String rebirthState,
                                              @RequestParam(value = "rebirthRemark") String rebirthRemark,
                                              @RequestParam(value = "rebirthRelieve") String rebirthRelieve,
                                              @RequestParam(value = "rebirthSettle") String rebirthSettle,
                                              @RequestParam(value = "rebirthChange") String rebirthChange,
                                              @RequestParam(value = "rebirthReduce") String rebirthReduce,
                                              @RequestParam(value = "rebirthPay") String rebirthPay,
                                              @RequestParam(value = "rebirthRepay") String rebirthRepay,
